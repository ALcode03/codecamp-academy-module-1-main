...
Context
When working with loops, programmers often need to analyze numbers and apply mathematical rules. In this exercise, you will practice using nested for loops, conditional logic, and counters in JavaScript.

Objective
Write a Node.js program that counts how many numbers between 1 and 100 have exactly 3 divisors.

A divisor of a number is any integer that divides the number without leaving a remainder.
...
Total numbers between 1 and 100 with exactly 3 divisors:
...
If the number has exactly 3 divisors, increase the counter
Skills Practiced
Nested for loops
Modulus operator %
